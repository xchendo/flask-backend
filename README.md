...
# Note
If starting the app for the first time on your local here are somethings to note:
* When setting up postgres, the hostname is "postgres"
* When using Postman, the app starts port:3000
